...
def draw(view, ax=None, t_min = -1, t_max = -1, ch_min = -1, ch_max = -1):
...
def plot_ed(nameout="", option=None, to_be_shown=False):
...
def plot_ed_data(option=None, to_be_shown=False):
    plot_ed(nameout="data", option=option, to_be_shown=to_be_shown)
